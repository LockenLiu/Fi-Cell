...
rule mk_annot:
    ...
    params:
        ...
        chr = "{chromosome}"
    shell:
        "python scripts/5-mk_annot.py --cell {params.cell} --outdir {params.dir} --chr {params.chr}"
...
rule ldsc:
    ...
    shell:
        "sh scripts/10-ldsc.sh {params.outdir} {params.baselinemodeldir} {params.cell} {params.celllddir} {params.trait} {params.traitgwassumstatsdir}"
