...
rule ldsc:
    ...
    shell:
        "sh scripts/10-ldsc.sh {params.outdir} {params.baselinemodeldir} {params.cell} {params.celllddir} {params.trait} {params.traitgwassumstatsdir} {params.conditionlddir} {params.conditionprefix}"