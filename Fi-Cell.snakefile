...
tss_coordinate_GRCh38 = config['TSS_COORDINATE_GRCh38']
...
rule ldsc:
    ...
    shell:
        "sh scripts/12-ldsc.sh {params.outdir} {params.baselinemodeldir} {params.cell} {params.celllddir} {params.trait} {params.traitgwassumstatsdir}"