...
#temp = expand("{BASE_OUTPUT_DIR}/precomputation/cisCor/{cell_type}.cisCorfilt.pval5e-2.tsv", BASE_OUTPUT_DIR=BASE_OUTPUT_DIR, #cell_type=CELL_TYPES)
list_target_files.append(temp)
...
rule mk_annot:
    ...
    params:
        ...
        cell = "{cell_type}"
    shell:
        "sh scripts/5-mk_annot.sh {params.cell} {params.dir}"
...
rule split_ldscore:
    ...
    shell:
        "python scripts/8-split_ldscore.py -l {params.combined_ld_dir} -c {params.cell_ld_dir} -p {params.prefix}"
...
rule ldsc:
    ...
    shell:
        "sh scripts/9-ldsc.sh {params.outdir} {params.baselinemodeldir} {params.cell} {params.celllddir} {params.trait} {params.traitgwassumstatsdir}"
