...
bedtools multiinter -i ${dir}/precomputation/bed/*.bed | awk -v N=$(ls ${dir}/precomputation/bed/*.bed | wc -l) '$4 == N {print $1, $2, $3, 1}' OFS='\t' > ${dir}/precomputation/condition_ldscore/${condition_prefix}.bed
